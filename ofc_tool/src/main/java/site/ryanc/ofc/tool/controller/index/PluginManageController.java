...
import site.ryanc.ofc.tool.plugin.AddPluginResult;
import site.ryanc.ofc.tool.plugin.PluginClassLoader;
import site.ryanc.ofc.tool.plugin.PluginManager;
import site.ryanc.ofc.tool.plugin.PluginParser;
import site.ryanc.ofc.tool.services.index.PluginManageService;
import site.ryanc.ofc.tool.view.index.PluginManageView;
...
public class PluginManageController extends PluginManageView {
    ...
    public static final String FXML = "/site/ryanc/ofc/tool/fxmlView/index/PluginManage.fxml";
