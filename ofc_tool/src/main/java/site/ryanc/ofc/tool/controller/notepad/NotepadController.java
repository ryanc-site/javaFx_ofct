package site.ryanc.ofc.tool.controller.notepad;

import site.ryanc.ofc.tool.common.utils.NodeUtils;
import site.ryanc.ofc.tool.view.notepad.NotepadView;
    ...
    private Tab createTab() {
        ...
        try {
            Node content = FXMLLoader.load(NotepadController.class
                .getResource("/site/ryanc/ofc/tool/fxmlView/notepad-tab.fxml")
            );
