package site.ryanc.ofc.tool.newui;

import site.ryanc.ofc.tool.Main;
import site.ryanc.ofc.tool.controller.index.IndexController;
import site.ryanc.ofc.tool.controller.index.PluginManageController;
import site.ryanc.ofc.tool.event.AppEvents;
import site.ryanc.ofc.tool.event.PluginEvent;
import site.ryanc.ofc.tool.model.PluginJarInfo;
import site.ryanc.ofc.tool.newui.creator.CreatePluginProjectService;
import site.ryanc.ofc.tool.newui.creator.PluginProjectInfo;
import site.ryanc.ofc.tool.plugin.PluginManager;
import site.ryanc.ofc.tool.plugin.PluginParser;
...
import site.ryanc.ofc.tool.common.utils.BoolUtils;
...
public class NewLauncherController {
    ...
    public void initialize() {
        ...
        startWebView.getEngine().load(IndexController.welcome_page); // 额外再打开一个反馈页面，可关闭
    ...
    private void loadPlugin(PluginJarInfo jarInfo) {
        ...
        if (BoolUtils.isNot(jarInfo.getIsEnable())) {
    ...
    public void openPluginCreator() {
        ...
        FxDialog<PluginCreatorController> dialog = new FxDialog<PluginCreatorController>()
            .setTitle("创建自己的插件")
            .setBodyFxml("/site/ryanc/ofc/tool/fxmlView/newui/plugin-creator.fxml")
            .setOwner(FxApp.primaryStage)
            .setResizable(true)
