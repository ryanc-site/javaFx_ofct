...
import site.ryanc.ofc.tool.common.constant.ElementEnum;
import site.ryanc.ofc.tool.common.constant.TitleFontEnum;

import java.io.*;

import static site.ryanc.ofc.tool.common.constant.Constant.COMMONATTR;
...
public class HtmlUtil {
    ...
    public static void resolveHtml(String ritchText, XWPFDocument doc, XWPFParagraph paragraph){
        ...
        try {
            ...
            Elements elements = document.select("["+COMMONATTR+"]");
            for (Element em : elements) {
                XmlCursor xmlCursor = paragraph.getCTP().newCursor();
                switch (em.attr(COMMONATTR)) {
                    case "title":
                        break;
                    case "subtitle":
                        break;
